<section class="section-contacto">
    <div class="contenedor contacto-contenedor">
        <h1>Quieres vender tu patinete o bicicleta eléctrica??</h1>
            <p>Si estas interesado en vender tu patinete o bicicleta eléctrica, rellena nuestro formulario y haz tu propuesta!!
            No te preocupes por el envió, nosotros lo pagamos.</p>
            <div class="ver-patinete btn1">
            <a href="contacto.php" class="boton-patinetes">Formulario de cantacto</a>
        </div>  
    </div>
