<?php
    ...
    $db = conexionDB();
    // consulta a la bbdd(patinetes)     
    $query = "SELECT * FROM patinetes LIMIT ${limite}";

    // Obtener resultados
    $consulta = mysqli_query($db, $query);
 
    // consulta a la bbdd(repuestos) 
    $query2 = "SELECT * FROM repuestos LIMIT ${limite}";
    // Obtener resultados
...
?>                  
                    ...
                    <div class="producto">
                        <img loading="lazy" class="iss" src="imagenes/<?php echo $patinetes['imagen']; ?>" alt="patinete">                    
                            <div class="contenido-producto">
                                ...
                                <p>Modelo: <?php echo $patinetes['modelo']; ?></p>
                ...
                <div class="ver-patinete">
                    <a href="patinetes.php" class="boton-patinetes">Ver todos</a>
                </div>
            </section>
                ...
                <div class="contenedor ver-patinete">
                    <a href="repuestos.php" class="boton-patinetes">Ver todos</a>
            </div>
